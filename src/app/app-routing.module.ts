...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'purchase',
        loadChildren: () => import('./demo/pages/purchase/purchase.module').then(module => module.PurchaseModule)
      },
      {
        path: 'sales',
        loadChildren: () => import('./demo/pages/sales/sales.module').then(module => module.SalesModule)
      }
    ]
  },
  {
